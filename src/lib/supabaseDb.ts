...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const toProducto = (r: any): Producto => ({ id: r.id, nombre: r.nombre, costoMoTotal: r.costo_mo_total, precioServicio: r.precio_servicio, telaBase: r.tela_base ?? undefined, limiteConsumo: r.limite_consumo ?? undefined, limiteRendimiento: r.limite_rendimiento ?? undefined, recetaComplementos: r.receta_complementos ?? undefined, notas: r.notas });
// eslint-disable-next-line @typescript-eslint/no-explicit-any
...
const fromProducto = (v: Producto) => ({ id: v.id, nombre: v.nombre, costo_mo_total: v.costoMoTotal, precio_servicio: v.precioServicio, tela_base: v.telaBase ?? null, limite_consumo: v.limiteConsumo ?? null, limite_rendimiento: v.limiteRendimiento ?? null, receta_complementos: v.recetaComplementos ?? null, notas: v.notas });
